...
async def get_current_user(conn: SessionDep, token: Annotated[str, Depends(oauth2_scheme)], settings: Annotated[Settings, Depends(get_settings)]):
...
async def register_user(
    form_data: Annotated[UserRegistration, Form()],
    conn: SessionDep
):
